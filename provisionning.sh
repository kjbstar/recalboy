...
php -r "copy('https://raw.githubusercontent.com/kjbstar/recalboy/master/composer-setup.php', 'composer-setup.php');"
...
echo ""
echo "${GREEN}Go here to finish configuration (Activate RetroArch Network Commands):${RESET}"
echo "http://${IP}/config"
